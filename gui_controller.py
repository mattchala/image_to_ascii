...
def make_window():
    ...
    layout = [
        [
            sg.Image('gui_imgs/top_logo.png'), 
...
while True:
    ...
    if event == '-SAVE-':
        ...
        ascii_file = open('ascii_output.txt', 'r+')
...
# make sure you are cd'd into the proper directory in the bottom window when testing in VS code
